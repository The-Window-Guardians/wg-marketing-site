...
'CALLS TO ACTION: sprinkle a soft CTA here and there — NOT every post (roughly one in three, or just one of the three caption options). Keep it light and varied: "free in-home estimate," "DM us," "link in bio," "we’re booking [season] now," "tap to get a quote," or "call/text 215-709-8793." Window Guardians’ real phone number is 215-709-8793 — use it in SOME CTAs (not every one). Use ONLY real offers (free estimate, financing). Never pushy, never the same CTA twice in a row.\n' +
...
'- End with a soft, low-pressure call to action for B2B readers (vary it, e.g. "If you manage a community with aging windows, we are glad to walk the property and scope it."). About 1 in 3 posts may include call or text 215-709-8793.\n' +
...
'- PRODUCT CREDIT (required): the product/brand must always appear somewhere. If you name it naturally in the caption, done. If you do NOT, add a FINAL line crediting it, formatted: "Installed: <product line + key features actually shown or stated>" — e.g. "Installed: ProVia Legacy Steel entry door · black grids · AZEK trim". Use ONLY products/features actually seen in the photo or stated in the facts/notes; NEVER invent a brand — if the exact brand is unknown, credit the generic type you can see (e.g. "Installed: new black double-hung windows"). About 1 in 3 posts, add a short CTA onto that line (free estimate · call/text 215-709-8793).\n';
