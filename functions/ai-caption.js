...
'CALLS TO ACTION: end MOST posts with a clear, soft call to action — aim for at least 2 of the 3 caption options to include one, usually as the LAST line. Keep it light and varied so it never feels spammy or salesy: "call or text 215-709-8793," "free in-home estimate," "link in bio," "DM us for a quote," "we’re booking [season] now," "tap to get a quote." Window Guardians’ real phone number is 215-709-8793 — work it in often, ideally at the very end of the post. Rotate the CTA so it is never the same one twice in a row. Use ONLY real offers (free estimate, financing). Confident and inviting, never pushy or braggy.\n' +
...
'- End EVERY post with a clear, low-pressure call to action for B2B readers, varied each time (e.g. "If you manage a community with aging windows, we are glad to walk the property and scope it," or "Reach out anytime to talk through a project"). MOST posts should give a direct way to reach us at the very end: call or text 215-709-8793, or a soft invite to connect or message. Keep it professional, never pushy.\n' +
...
'- PRODUCT CREDIT (required): the product/brand must always appear somewhere. If you name it naturally in the caption, done. If you do NOT, add a FINAL line crediting it, formatted: "Installed: <product line + key features actually shown or stated>" — e.g. "Installed: ProVia Legacy Steel entry door · black grids · AZEK trim". Use ONLY products/features actually seen in the photo or stated in the facts/notes; NEVER invent a brand — if the exact brand is unknown, credit the generic type you can see (e.g. "Installed: new black double-hung windows"). On MOST posts, add a short CTA onto that final line, varied each time (free estimate · call or text 215-709-8793 · link in bio · DM for a quote). Lean toward ending with the phone number or "link in bio."\n';
...
'3) BRAND + SERIES — ONLY if the caption names a specific product/brand. Tag the BRAND in EXACTLY 2 ways: the brand alone + brand-with-product-type (e.g. #Okna + #OknaWindows, or #ProVia + #ProViaDoors, or #JamesHardie + #HardieSiding). THEN, if a series/model is named, add the SERIES as its OWN standalone tag (e.g. #700Series, #LegacySteel). So a named Okna 700 job = #Okna #OknaWindows #700Series. Brand/series names ONLY — NEVER feature hashtags (no #LowEGlass, #FoamFilled, #PrairieGrids — tiny search volume). If the caption does NOT name a specific product/brand, SKIP this group entirely.\n' +
...
'Write the full post now as JSON.';
      ...
      var boldRule =
        (style==='boldmax'||edge>=2)
          ? '- MODE: BOLD MAX 🔥🔥 — absolutely UNHINGED, maximum chaos, turned up to 11. Liquid Death / Old Spice on a sugar high: absurd premises, wild over-the-top metaphors, theatrical drama, deadpan savagery, personify the old units as full-blown villains. Take swings that feel genuinely reckless. Do NOT hold back, do NOT play it safe, do NOT sound remotely like a company. STILL land it on the real craftsmanship by the last line, and the hard guardrails are ABSOLUTE. 1 to 3 explosive sentences.'
        : (edge<=0)
          ? '- MODE: BOLD — full witty/edgy brand voice, a real scroll-stopping head-turner. Open with a pattern-breaking hook, sharp wit, dry sarcasm, a little bite. Lean on the recurring villains (old/ugly/drafty units, the years-long procrastination, neighbor envy). Clever never crude, confident never corny. 1 to 3 punchy sentences.'
          : '- MODE: BOLDER — crank it up well past normal bold: cheeky, attitude-forward, push further than feels comfortable. A bigger hook, more swagger, a wilder/unexpected angle, a personified jab at the old unit — gleefully over the top, while still landing on the real product by the end. 1 to 3 punchy sentences.';
      var styleRule =
